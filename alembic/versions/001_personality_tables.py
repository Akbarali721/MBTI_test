...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("premium_requested", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("token"),
    )
    op.create_index("ix_personality_test_sessions_token", "personality_test_sessions", ["token"])
    op.create_index("ix_personality_test_sessions_user_id", "personality_test_sessions", ["user_id"])
    op.create_index("ix_personality_test_sessions_telegram_user_id", "personality_test_sessions", ["telegram_user_id"])
    ...
    op.create_index("ix_personality_answers_session_id", "personality_answers", ["session_id"])
    ...
    op.create_index("ix_personality_result_contents_personality_type", "personality_result_contents", ["personality_type"])
