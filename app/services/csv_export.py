...
SESSION_HEADER = (
    ...
    "natija",
    "premium",
    "bepul_premium_tugashi (UTC+5)",
    "taklif_qilgan_sessiya",
    "premium_sorovi",
    "javoblar",
    "jami_savol",
    "telegram_username",
...
def _session_query(filters: ExportFilters) -> Select:
    ...
    stmt = select(
        ...
        model.source,
        model.intent,
        model.feedback_rating,
        model.feedback_interest,
        model.result_type,
        model.is_premium,
        # Bepul (referal) premium to'langanidan ATAYLAB ajratilgan: hisobotda
        # ular qo'shilib ketsa sotuv soni yolg'on chiqardi.
        model.premium_until,
        model.referred_by_session_id,
