...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "uz": {
        ...
        # Maqsad (intent)
        "intent.title": "Siz ko‘proq nimani bilmoqchisiz?",
        "intent.option.strengths": "Kuchli tomonlarimni",
        "intent.option.career": "Menga mos kasb yoki yo‘nalishni",
        "intent.option.self_understanding": "O‘zimni yaxshiroq tushunishni",
        "intent.option.curiosity": "Shunchaki qiziqib ko‘ryapman",
        "intent.error": "Davom etish uchun bitta variantni tanlang.",
        # Natija feedback
        "feedback.rating.title": "Natija sizga qanchalik mos tushdi?",
        "feedback.rating.very_accurate": "Juda mos",
        "feedback.rating.partly_accurate": "Qisman mos",
        "feedback.rating.not_accurate": "Unchalik mos emas",
        "feedback.interest.title": "Yana nimani bilishni xohlardingiz?",
        "feedback.interest.career": "Kasb va ish yo‘nalishim",
        "feedback.interest.strengths": "Kuchli va zaif tomonlarim",
        "feedback.interest.relationships": "Munosabatlarda qandayman",
        "feedback.interest.stress": "Stress paytida qanday o‘zgaraman",
        "feedback.interest.confidence": "O‘zimga ishonch",
        "feedback.skip": "O‘tkazib yuborish",
        # Savol
    ...
    "ru": {
        ...
        # Цель (intent)
        "intent.title": "Что вы хотите узнать?",
        "intent.option.strengths": "Свои сильные стороны",
        "intent.option.career": "Подходящую профессию или направление",
        "intent.option.self_understanding": "Лучше понять себя",
        "intent.option.curiosity": "Просто из любопытства",
        "intent.error": "Выберите один вариант, чтобы продолжить.",
        # Обратная связь
        "feedback.rating.title": "Насколько результат вам подошёл?",
        "feedback.rating.very_accurate": "Очень подошёл",
        "feedback.rating.partly_accurate": "Частично подошёл",
        "feedback.rating.not_accurate": "Не очень подошёл",
        "feedback.interest.title": "Что ещё хотели бы узнать?",
        "feedback.interest.career": "Профессию и направление работы",
        "feedback.interest.strengths": "Сильные и слабые стороны",
        "feedback.interest.relationships": "Как я в отношениях",
        "feedback.interest.stress": "Как я меняюсь в стрессе",
        "feedback.interest.confidence": "Уверенность в себе",
        "feedback.skip": "Пропустить",
        # Вопрос
