...
def answer_question(client, token: str, question_index: int, *, option_index: int = 0) -> str:
...
def complete_session(
    ...
    *,
    ...
    question_index = 0
    while True:
        location = answer_question(client, token, question_index, option_index=option_index)
